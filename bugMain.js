...
for (var i = 0; i < 10; i++) {
    // missing feature : random grass position generation
    pos = 10*i
...
function Projectile(width, height, gravity, bounce, rotate) {
    ...
    this.update = function() {
        ...
        // missing feature : arrow-ground collision
    }

    this.doesCollide = function(target) {
        return (
            // missing feature : projectile-host collision detection (eg. arrow-board collisions)
            false // hint: should this function always return false? when should thie function return true?          
        )
    }
}  // Projectile
...
function drawPath() {
    ...
    canvasContext.moveTo( // hint: starting coordinates
        10, 
        10); 
    canvasContext.lineTo( // hint: ending coordinates
       200,  
       300);
...
function drawBackground() {    
    ...
    // ground
    // missing feature : missing grass layer
